"""Constants for PokeMMO Companion."""

# Pokemon type list (Gen 5 — 17 types, no Fairy)
TYPES = [
...
# Type effectiveness matrix (Gen 5 — no Fairy type)
# Key: (attacking_type, defending_type) -> multiplier
# Only storing non-1.0 values
...
# Shiny rates in PokeMMO
SHINY_RATE_BASE = 1 / 30000
SHINY_RATE_DONATOR = 1 / 27000
SHINY_RATE_CHARM = 1 / 27000
SHINY_RATE_BOTH = 1 / 24000
